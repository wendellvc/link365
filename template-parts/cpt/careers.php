...
function careers() {
    ...
    $labels = array(
        'name'               => 'Careers', // General name. ie: Posts/Pages
        'singular_name'      => 'Career', // Name for single object. ie: Post/Page
        'menu_name'          => 'Careers', // Name used in the menu
        'name_admin_bar'     => 'Career', // String for use in admin menu bar. - New Book
        'add_new_item'       => 'Add New Career', // Default is 'Add New Post/Add New Page'
        'new_item'           => 'New Career', // Default is New Post/New Page.
        'edit_item'          => 'Edit Career', // Default is Edit Post/Edit Page.
        'view_item'          => 'View Career', // Default is View Post/View Page.
        'all_items'          => 'All Careers', // String for the submenu. ie: All Posts/All Pages.
        'search_items'       => 'Search Careers', // Default is Search Posts/Pages
        'parent_item_colon'  => 'Parent Careers:', // This string is used in hierarchical types. The default is 'Parent Page:'.
        'not_found'          => 'No careers found.', // Default is No posts found/No pages found.
        'not_found_in_trash' => 'No careers found in Trash.', // Default is No posts found in Trash/No pages found in Trash.
        'featured_image'        => 'Career Featured Image', // Default is Featured Image.
        'set_featured_image'    => 'Set career featured image', // Default is Set featured image.
        'remove_featured_image' => 'Remove career featured image', // Default is Remove featured image.
        'use_featured_image'    => 'Use as career featured image', // Default is Use as featured image.
        'items_list'            => 'Careers list', // String for the table hidden heading.
        'items_list_navigation' => 'Careers list navigation', // String for the table pagination hidden heading.
